...
/**
 * DocumentFilterStatus Class Doc Comment
 *
 * @category Class
 * @package  Lacuna\Signer
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocumentFilterStatus
{
    /**
     * Possible values of this enum
     */
    const PENDING_OR_REFUSED = 'PendingOrRefused';
const CONCLUDED = 'Concluded';
const CANCELED_OR_EXPIRED = 'CanceledOrExpired';
...
const EXPIRED = 'Expired';
    ...
    {
        return [
            self::PENDING_OR_REFUSED,
self::CONCLUDED,
self::CANCELED_OR_EXPIRED,
self::PENDING,
self::REFUSED,
self::CANCELED,
self::EXPIRED,        ];
