...
/**
 * UsersParticipantUserModel Class Doc Comment
 *
 * @category Class
 * @package  Lacuna\Signer
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UsersParticipantUserModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Users.ParticipantUserModel';
...
'phone' => 'getPhone'    ];
     ...
     * Sets identifier
     *
     * @param string $identifier The user identifier (CPF in Brazil and Cédula de Identidad in Ecuador).
     *
     * @return $this
     */
     ...
     * Sets phone
     *
     * @param string $phone The user's mobile phone number. It will be set only if the user does not exist, i.e. it will not override  existing user's phones.  Must use iternational format, example: +55 11 91234-5678
     *
     * @return $this
     */
