...
'title' => 'getTitle'    ];
     ...
     *
     * @param bool $requireCompanyCertificate [DEPRECATED] The user is required to sign the document with a company certificate (e.g. e-CNPJ). Please use Lacuna.Signer.Api.FlowActions.FlowActionModel.RequiredCertificateHolderTypeToSign instead.
     *
     * @return $this
     */
     ...
     *
     * @param string $requiredCompanyIdentifier The user is required to sign the document with a company certificate (e.g. e-CNPJ) that has the provided company identifier.
     *
     * @return $this
     */
     ...
     *
     * @param bool $allowRuleFlowToContinueIfRefused allowRuleFlowToContinueIfRefused
     *
     * @return $this
     */
