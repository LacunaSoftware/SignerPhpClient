...
/**
 * NotificationsCreateFlowActionReminderRequest Class Doc Comment
 *
 * @category Class
 * @package  Lacuna\Signer
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NotificationsCreateFlowActionReminderRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Notifications.CreateFlowActionReminderRequest';
...
'flowActionId' => 'getFlowActionId'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['flowActionId'] === null) {
            $invalidProperties[] = "'flowActionId' can't be null";
        }
