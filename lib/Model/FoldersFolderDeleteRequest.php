...
/**
 * FoldersFolderDeleteRequest Class Doc Comment
 *
 * @category Class
 * @package  Lacuna\Signer
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FoldersFolderDeleteRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Folders.FolderDeleteRequest';
    ...
    protected static $swaggerTypes = [
        'deleteAction' => '\Lacuna\Signer\Model\DeleteAction',
...
'destinationFolderId' => 'setDestinationFolderId'    ];
...
'destinationFolderId' => 'getDestinationFolderId'    ];
    ...
    {
        $this->container['deleteAction'] = isset($data['deleteAction']) ? $data['deleteAction'] : null;
        $this->container['destinationFolderId'] = isset($data['destinationFolderId']) ? $data['destinationFolderId'] : null;
    }
     ...
     * Gets deleteAction
     *
     * @return \Lacuna\Signer\Model\DeleteAction
     */
    public function getDeleteAction()
    {
        return $this->container['deleteAction'];
    }

    /**
     * Sets deleteAction
     *
     * @param \Lacuna\Signer\Model\DeleteAction $deleteAction deleteAction
     *
     * @return $this
     */
    public function setDeleteAction($deleteAction)
    {
        $this->container['deleteAction'] = $deleteAction;

        return $this;
    }

    /**
     * Gets destinationFolderId
     *
     * @return string
     */
    public function getDestinationFolderId()
    {
        return $this->container['destinationFolderId'];
    }

    /**
     * Sets destinationFolderId
     *
     * @param string $destinationFolderId The folder to which the documents will be moved (if Lacuna.Signer.Api.Folders.FolderDeleteRequest.DeleteAction is Lacuna.Signer.Api.DeleteAction.MoveContent).  This value can be null if you want to keep the documents with no folder.
     *
     * @return $this
     */
    public function setDestinationFolderId($destinationFolderId)
    {
        $this->container['destinationFolderId'] = $destinationFolderId;
