...
/**
 * TransactionsPriceRangeModel Class Doc Comment
 *
 * @category Class
 * @package  Lacuna\Signer
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransactionsPriceRangeModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Transactions.PriceRangeModel';
...
'price' => 'getPrice'    ];
     ...
     * Sets limit
     *
     * @param int $limit The upper limit of the price range.  If the limit is null, this is the price when the number of transactions exceed the limit of all the other ranges.
     *
     * @return $this
     */
