<?php
/**
 * DocumentsDocumentNotifiedEmailsEditRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * DocumentsDocumentNotifiedEmailsEditRequest Class Doc Comment
 *
 * @category Class
 * @package  Lacuna\Signer
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocumentsDocumentNotifiedEmailsEditRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Documents.DocumentNotifiedEmailsEditRequest';
     ...
     * Sets emails
     *
     * @param string[] $emails The emails to notify when the document is concluded.
     *
     * @return $this
     */
