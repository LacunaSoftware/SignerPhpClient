...
/**
 * HealthDocumentsHealthProfessionalModel Class Doc Comment
 *
 * @category Class
 * @package  Lacuna\Signer
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HealthDocumentsHealthProfessionalModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HealthDocuments.HealthProfessionalModel';
...
'region' => 'getRegion'    ];
     ...
     * Sets id
     *
     * @param string $id The professional ID number (e.g CRM)
     *
     * @return $this
     */
     ...
     * Sets region
     *
     * @param string $region The professional ID region (a.k.a UF)
     *
     * @return $this
     */
