<?php
/**
 * SignaturePixAuthenticationModel
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * SignaturePixAuthenticationModel Class Doc Comment
 *
 * @category Class
 * @package  Lacuna\Signer
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SignaturePixAuthenticationModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Signature.PixAuthenticationModel';
...
'paymentDate' => 'getPaymentDate'    ];
    ...
    {
        $this->container['endToEndId'] = isset($data['endToEndId']) ? $data['endToEndId'] : null;
        $this->container['pixKey'] = isset($data['pixKey']) ? $data['pixKey'] : null;
    ...
    {
        return $this->container['endToEndId'];
    }
    ...
    {
        $this->container['endToEndId'] = $endToEndId;
