...
class WebhookTypes
{
     ...
     */
    const DOCUMENT_CONCLUDED = 'DocumentConcluded';
const INVOICE_CLOSED = 'InvoiceClosed';
const DOCUMENT_REFUSED = 'DocumentRefused';
const DOCUMENT_APPROVED = 'DocumentApproved';
const DOCUMENT_SIGNED = 'DocumentSigned';
const DOCUMENT_CANCELED = 'DocumentCanceled';
const DOCUMENT_EXPIRED = 'DocumentExpired';
const DOCUMENTS_CREATED = 'DocumentsCreated';
    /**
    ...
    {
        return [
            self::DOCUMENT_CONCLUDED,
self::INVOICE_CLOSED,
self::DOCUMENT_REFUSED,
