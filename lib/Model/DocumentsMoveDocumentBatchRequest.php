<?php
/**
 * DocumentsMoveDocumentBatchRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * DocumentsMoveDocumentBatchRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocumentsMoveDocumentBatchRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Documents.MoveDocumentBatchRequest';
...
'newFolderName' => 'getNewFolderName'    ];
     ...
     * Sets documents
     *
     * @param string[] $documents The Ids of the documents that will be moved.
     *
     * @return $this
     */
     ...
     * Sets folderId
     *
     * @param string $folderId The Id of the folder to which the document(s) will be moved.  The folder Id can be null if you want to move the document(s) to no folder or if you want to create a new folder using Lacuna.Signer.Api.Documents.MoveDocumentRequest.NewFolderName.
     *
     * @return $this
     */
     ...
     * Sets newFolderName
     *
     * @param string $newFolderName The name of the folder to be created and the documents will be moved to. (If Lacuna.Signer.Api.Documents.MoveDocumentRequest.FolderId is null)
     *
     * @return $this
     */
