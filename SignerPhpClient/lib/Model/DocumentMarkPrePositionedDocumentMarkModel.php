...
/**
 * DocumentMarkPrePositionedDocumentMarkModel Class Doc Comment
 *
 * @category Class
 * @description Model used to set the position of a document mark before it&#x27;s associated flow action is completed.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocumentMarkPrePositionedDocumentMarkModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DocumentMark.PrePositionedDocumentMarkModel';
    ...
    protected static $swaggerTypes = [
        'type' => '\Lacuna\Signer\Model\DocumentMarkType',
'uploadId' => 'string',
'topLeftX' => 'double',
'topLeftY' => 'double',
'width' => 'double',
...
'pageNumber' => 'getPageNumber'    ];
     ...
     * Gets type
     *
     * @return \Lacuna\Signer\Model\DocumentMarkType
     */
     ...
     * Sets type
     *
     * @param \Lacuna\Signer\Model\DocumentMarkType $type type
     *
     * @return $this
     */
     ...
     * Sets uploadId
     *
     * @param string $uploadId The file to which this mark should be applied.  If null it will be applied to all sent files.
     *
     * @return $this
     */
     ...
     * Sets topLeftX
     *
     * @param double $topLeftX X position of the top left point of the mark (in PDF points).
     *
     * @return $this
     */
     ...
     * Sets topLeftY
     *
     * @param double $topLeftY Y position of the top left point of the mark (in PDF points).
     *
     * @return $this
     */
     ...
     * Sets width
     *
     * @param double $width Width of the mark (in PDF points).
     *
     * @return $this
     */
     ...
     * Sets height
     *
     * @param double $height Height of the mark (in PDF points).
     *
     * @return $this
     */
     ...
     * Sets pageNumber
     *
     * @param int $pageNumber The page number of the mark.
     *
     * @return $this
     */
