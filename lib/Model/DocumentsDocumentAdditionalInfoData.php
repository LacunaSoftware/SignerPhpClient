<?php
/**
 * DocumentsDocumentAdditionalInfoData
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * DocumentsDocumentAdditionalInfoData Class Doc Comment
 *
 * @category Class
 * @package  Lacuna\Signer
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocumentsDocumentAdditionalInfoData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Documents.DocumentAdditionalInfoData';
    ...
    protected static $swaggerTypes = [
        'healthData' => '\Lacuna\Signer\Model\HealthDocumentsHealthDocumentData',
...
'metadata' => 'getMetadata'    ];
    ...
    {
        $this->container['healthData'] = isset($data['healthData']) ? $data['healthData'] : null;
     ...
     * Gets healthData
     *
     * @return \Lacuna\Signer\Model\HealthDocumentsHealthDocumentData
     */
    public function getHealthData()
    {
        return $this->container['healthData'];
    }

    /**
     * Sets healthData
     *
     * @param \Lacuna\Signer\Model\HealthDocumentsHealthDocumentData $healthData healthData
     *
     * @return $this
     */
    public function setHealthData($healthData)
    {
        $this->container['healthData'] = $healthData;
     ...
     * Sets fields
     *
     * @param map[string,string] $fields Form fields to fill when creating the document.
     *
     * @return $this
     */
     ...
     * Sets metadata
     *
     * @param map[string,string] $metadata PDF custom metadata to add when creating the document
     *
     * @return $this
     */
