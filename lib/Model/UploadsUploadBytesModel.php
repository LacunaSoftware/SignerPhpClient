...
/**
 * UploadsUploadBytesModel Class Doc Comment
 *
 * @category Class
 * @package  Lacuna\Signer
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UploadsUploadBytesModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Uploads.UploadBytesModel';
...
'digest' => 'getDigest'    ];
     ...
     * Sets id
     *
     * @param string $id The ID of the uploaded file so it can be used to create documents.
     *
     * @return $this
     */
     ...
     * Sets size
     *
     * @param int $size The size in bytes of the received file.
     *
     * @return $this
     */
     ...
     * Sets digest
     *
     * @param string $digest The MD5 digest (hash) of the received file. Can be used for integrity checks.
     *
     * @return $this
     */
