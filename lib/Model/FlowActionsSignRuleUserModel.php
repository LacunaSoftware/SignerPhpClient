...
/**
 * FlowActionsSignRuleUserModel Class Doc Comment
 *
 * @category Class
 * @package  Lacuna\Signer
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FlowActionsSignRuleUserModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FlowActions.SignRuleUserModel';
...
'refusalReason' => 'getRefusalReason'    ];
     ...
     * Sets identifier
     *
     * @param string $identifier The user identifier (CPF in Brazil or Cédula de Identidad in Ecuador).
     *
     * @return $this
     */
     ...
     * Sets signatureDate
     *
     * @param \DateTime $signatureDate signatureDate
     *
     * @return $this
     */
