...
/**
 * WebhooksInvoiceClosedModel Class Doc Comment
 *
 * @category Class
 * @package  Lacuna\Signer
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WebhooksInvoiceClosedModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Webhooks.InvoiceClosedModel';
...
'year' => 'int',
'value' => 'double',
'invoiceTotals' => '\Lacuna\Signer\Model\InvoicesInvoiceTotalModel[]',
'organization' => '\Lacuna\Signer\Model\OrganizationsOrganizationInfoModel',
'billingInformation' => '\Lacuna\Signer\Model\BillingBillingInformationModel'    ];
...
'billingInformation' => 'getBillingInformation'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['invoiceTotals'] = isset($data['invoiceTotals']) ? $data['invoiceTotals'] : null;
     ...
     * Gets invoiceTotals
     *
     * @return \Lacuna\Signer\Model\InvoicesInvoiceTotalModel[]
     */
    public function getInvoiceTotals()
    {
        return $this->container['invoiceTotals'];
    }

    /**
     * Sets invoiceTotals
     *
     * @param \Lacuna\Signer\Model\InvoicesInvoiceTotalModel[] $invoiceTotals invoiceTotals
     *
     * @return $this
     */
    public function setInvoiceTotals($invoiceTotals)
    {
        $this->container['invoiceTotals'] = $invoiceTotals;
     ...
     *
     * @return \Lacuna\Signer\Model\BillingBillingInformationModel
     */
     ...
     *
     * @param \Lacuna\Signer\Model\BillingBillingInformationModel $billingInformation billingInformation
     *
     * @return $this
     */
