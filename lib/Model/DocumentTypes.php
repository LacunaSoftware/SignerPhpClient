...
class DocumentTypes
{
     ...
     */
    const DEED = 'Deed';
const POWER_OF_ATTORNEY = 'PowerOfAttorney';
const PRESCRIPTION = 'Prescription';
const MEDICAL_CERTIFICATE = 'MedicalCertificate';
const EXAM_REQUEST = 'ExamRequest';
const LAB_REPORT = 'LabReport';
const DISCHARGE_SUMMARY = 'DischargeSummary';
const CLINICAL_RECORD = 'ClinicalRecord';
const DRUG_DISPENSING = 'DrugDispensing';
