<?php
/**
 * HealthDocumentsHealthDocumentData
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * HealthDocumentsHealthDocumentData Class Doc Comment
 *
 * @category Class
 * @description This option is only valid for the following document types: Prescription, MedicalCertificate, ExamRequest, LabReport, DischargeSummary, ClinicalRecord, DrugDispensing, Vaccination and MedicalReport
 * @package  Lacuna\Signer
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HealthDocumentsHealthDocumentData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HealthDocuments.HealthDocumentData';
    ...
    protected static $swaggerTypes = [
        'professional' => '\Lacuna\Signer\Model\HealthDocumentsHealthProfessionalModel',
'items' => '\Lacuna\Signer\Model\HealthDocumentsHealthItemModel[]'    ];
...
'items' => 'getItems'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['professional'] === null) {
            $invalidProperties[] = "'professional' can't be null";
        }
     ...
     * Gets professional
     *
     * @return \Lacuna\Signer\Model\HealthDocumentsHealthProfessionalModel
     */
     ...
     * Sets professional
     *
     * @param \Lacuna\Signer\Model\HealthDocumentsHealthProfessionalModel $professional professional
     *
     * @return $this
     */
     ...
     * Gets items
     *
     * @return \Lacuna\Signer\Model\HealthDocumentsHealthItemModel[]
     */
     ...
     * Sets items
     *
     * @param \Lacuna\Signer\Model\HealthDocumentsHealthItemModel[] $items Additional strutctured information for health documents. Can be used to display medication information.
     *
     * @return $this
     */
