...
/**
 * DocumentMarkType Class Doc Comment
 *
 * @category Class
 * @package  Lacuna\Signer
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocumentMarkType
{
    /**
     * Possible values of this enum
     */
    const SIGNATURE_VISUAL_REPRESENTATION = 'SignatureVisualRepresentation';
const SIGNATURE_INITIALS = 'SignatureInitials';
const AUTHENTICATION_STAMP = 'AuthenticationStamp';
    /**
    ...
    {
        return [
            self::SIGNATURE_VISUAL_REPRESENTATION,
self::SIGNATURE_INITIALS,
self::AUTHENTICATION_STAMP,        ];
    }
}
