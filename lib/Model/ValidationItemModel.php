...
/**
 * ValidationItemModel Class Doc Comment
 *
 * @category Class
 * @package  Lacuna\Signer
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ValidationItemModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ValidationItemModel';
...
'message' => 'string',
'detail' => 'string',
'innerValidationResults' => '\Lacuna\Signer\Model\ValidationResultsModel'    ];
...
'message' => 'setMessage',
'detail' => 'setDetail',
'innerValidationResults' => 'setInnerValidationResults'    ];
...
'innerValidationResults' => 'getInnerValidationResults'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['innerValidationResults'] = isset($data['innerValidationResults']) ? $data['innerValidationResults'] : null;
    }
    ...
    /**
     * Gets innerValidationResults
     *
     * @return \Lacuna\Signer\Model\ValidationResultsModel
     */
    public function getInnerValidationResults()
    {
        return $this->container['innerValidationResults'];
    }

    /**
     * Sets innerValidationResults
     *
     * @param \Lacuna\Signer\Model\ValidationResultsModel $innerValidationResults innerValidationResults
     *
     * @return $this
     */
    public function setInnerValidationResults($innerValidationResults)
    {
        $this->container['innerValidationResults'] = $innerValidationResults;
