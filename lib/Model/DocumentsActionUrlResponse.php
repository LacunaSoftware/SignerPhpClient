...
/**
 * DocumentsActionUrlResponse Class Doc Comment
 *
 * @category Class
 * @package  Lacuna\Signer
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocumentsActionUrlResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Documents.ActionUrlResponse';
...
'embedUrl' => 'getEmbedUrl'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['embedUrl'] = isset($data['embedUrl']) ? $data['embedUrl'] : null;
    }
     ...
     * Sets url
     *
     * @param string $url The URL to redirect the user to the first pending action found.
     *
     * @return $this
     */
     ...
     * Sets embedUrl
     *
     * @param string $embedUrl The URL to embed the action in a iframe to use in your own application.
     *
     * @return $this
     */
