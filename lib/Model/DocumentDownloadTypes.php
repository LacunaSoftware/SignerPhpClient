...
/**
 * DocumentDownloadTypes Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocumentDownloadTypes
{
    /**
     * Possible values of this enum
     */
    const ORIGINAL = 'Original';
const PRINTER_FRIENDLY_VERSION = 'PrinterFriendlyVersion';
const SIGNATURES = 'Signatures';
const ORIGINAL_WITH_MARKS = 'OriginalWithMarks';
const SIGNING_TAGS = 'SigningTags';
const SIGNATURE_MARKS = 'SignatureMarks';
    /**
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::ORIGINAL,
self::PRINTER_FRIENDLY_VERSION,
self::SIGNATURES,
self::ORIGINAL_WITH_MARKS,
self::SIGNING_TAGS,
