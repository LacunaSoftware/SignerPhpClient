...
/**
 * UploadsUploadBytesRequest Class Doc Comment
 *
 * @category Class
 * @package  Lacuna\Signer
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UploadsUploadBytesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Uploads.UploadBytesRequest';
     ...
     * Sets bytes
     *
     * @param string $bytes The file bytes encoded in Base 64 format.
     *
     * @return $this
     */
